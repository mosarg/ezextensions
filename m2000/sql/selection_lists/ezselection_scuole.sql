...
CREATE TABLE `ezselection_scuole` (
  ...
  `nome_scuola` char(50) NOT NULL,
  `ubicazione` char(50) NOT NULL,
  PRIMARY KEY  (`nome_scuola`,`ubicazione`,`scuola`)
...
INSERT INTO `ezselection_scuole` VALUES ('ipsia','Ipsia','San Giorgio di Nogaro'),('ipssct','Ipssct','Palmanova'),('itc','Itc','Palmanova'),('iti_cervignano','Iti Cervignano','Cervignano'),('iti_san_giorgio','Iti San Giorgio','San Giorgio di Nogaro'),('liceo','Liceo','Cervignano');
...
-- Dump completed on 2009-08-24  7:28:10
