...
<link rel="
stylesheet" type="text/css" href={"stylesheets/print.css"|ezdesign} media="print" />
<!-- IE conditional comments; for bug fixes for different IE versions -->
<!--[if lte IE 8]> <style type="text/css"> @import url({"stylesheets/browsers/ie7fix2.css"|ezdesign(no)}); </style> <![endif]-->
