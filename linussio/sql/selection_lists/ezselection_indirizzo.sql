...
INSERT INTO `ezselection_indirizzo` VALUES ('liceo','pni','al','Pni'),('liceo','pni','cl','Pni'),('liceo','pni','bl','Pni'),('itc','igea','aigea','Igea'),('ipsc','biennio','ap','Biennio'),('ipsc','biennio','bp','Biennio'),('ipsc','turistico','bt','Turistico'),('ipsc','aziendale','ao','Aziendale'),('ipsia','ceconi','ac','Ceconi'),('ipsaa','agrotecnico','aad','Agrotecnico'),('ipsaa','agrotecnico','abd','Agrotecnico'),('ipsaa','agroambientale','aaq','Op. agroambientale'),('ipsaa','agroambientale','abq','Op. agroambientale');
...
-- Dump completed on 2009-08-20 14:30:40
