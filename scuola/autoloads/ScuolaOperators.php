...
class ScuolaOperators
{
    static function operators()
    {
        $operators = array(
            'scmaketime' => 'scmaketimeOperator',
            'scdatetime' => 'scdatetimeOperator',
        ...
        */
        ...
        {
            $eZTemplateOperatorArray[$operatorName] = array( 'script' => "extension/scuola/autoloads/classes/$operatorClass.php",
                                                             'class' => $operatorClass,
