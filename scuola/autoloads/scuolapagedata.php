<?php
//
// Definition of scuolaPageData class
//
...
class scuolaPageData
{
    function scuolaPageData()
    {
    }

    function operatorList()
    {
        return array( 'scuolapagedata', 'scuolapagedata_set', 'scuolapagedata_append' );
    }
    ...
    {
        return array( 'scuolapagedata' => array(
                           'params' => array( 'type' => 'array',
                                              'required' => false,
                                              'default' => array() ) ),
                      'scuolapagedata_set' => array(
    ...
    function modify( $tpl, $operatorName, $operatorParameters, $rootNamespace, $currentNamespace, &$operatorValue, $namedParameters )
    {
        switch ( $operatorName )
        {
            ...
            case 'scuolapagedata_set':
            case 'scuolapagedata_append':
            {
                self::setPersistentVariable( $namedParameters['key'], $namedParameters['value'], $tpl, $operatorName === 'scuolapagedata_append' );
            }break;
            case 'scuolapagedata':
            {                    
                $currentNodeId = 0;
                ...
                if ( isset( $parameters['current_node_id'] ) )
                {
                   ...
                   if ( isset( $parameters['set_current_node_path'] ) && $parameters['set_current_node_path'] )
                   {
                       ...
                       {
                           eZDebug::writeWarning( "Could not fetch 'current_node_id'", 'scuolaPageData::getNodePath()' );
                       }
                   }
                }
                ...
                $pageData['is_browse']           =( $uiContext === 'browse');
                ...
                */
                ...
                $pageData['no_class_menu'] = true;
                $pageData['no_prof_menu'] = true;
               ...
               if (isset($parameters['no_class_menu'])){
                   $pageData['no_class_menu']=$parameters['no_class_menu'];
                   $pageData['left_menu'] = false;
               }
                if (isset($parameters['no_prof_menu'])){
                   $pageData['no_prof_menu']=$parameters['no_prof_menu'];
                   $pageData['left_menu'] = false;
               }
               ...
               // Use custom left menu template. bool|string ( default: from menu.ini[SelectedMenu]LeftMenu )
                ...
                if ( $pageData['is_edit'] || strpos( $uriString, 'content/versionview' ) === 0 )
                {
                    ...
                    $pageData['no_class_menu']=false;
                    $pageData['no_prof_menu']=false;
                }
    ...
    static public function setPersistentVariable( $key, $value, $tpl, $append = false )
    {
        ...
        // storing the value internally as well in case this is not a view that supports persistent_variable (scuolapagedata will look for it)
