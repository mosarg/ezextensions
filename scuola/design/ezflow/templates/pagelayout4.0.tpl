...
<!--[if lte IE 7]> <style type="text/css"> @import url({"stylesheets/browsers/ie7lte.css"|ezdesign(no)}); </st	yle> <![endif]-->
...
<!-- Change between "sidemenu"/"sidemenu" and "extrainfo"/"noextrainfo" to switch display of side columns on or off  -->
  ...
  <div id="usermenu">
    ...
    <div class="corner-content">
        ...
        {else}
            ...
            <li><a href={"/user2/seltype"|ezurl} title="{$pagedesign.data_map.register_user_label.data_text|wash}">{$pagedesign.data_map.register_user_label.data_text|wash}</a></li>
            {/if}
