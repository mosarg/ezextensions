...
{def $lasturi=ezhttp( 'LastAccessesURI', 'session' )}
{* $lasturi *}
...
<script type="text/javascript" src={'javascript/include.js'|ezdesign} ></script>
<!--[if lte IE 8]> <script type="text/javascript" src={'javascript/iesucks.js'|ezdesign} ></script><![endif]-->
    ...
    <!-- Side menu area: START -->
     {if $pagedata.left_menu}
        <div id="sidemenu-position">
            ...
            {if $pagedata.persistent_variable.left_nav_menu}
