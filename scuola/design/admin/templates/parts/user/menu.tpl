...
<h4>{'Attiva utenti'|i18n( 'design/admin/parts/user/menu' )}</h4>
</div></div></div></div></div></div>
<div class="box-bc"><div class="box-ml"><div class="box-mr"><div class="box-bl"><div class="box-br"><div class="box-content">

<ul>
    <li><a href={'user2/list/0'|ezurl} title="{'Gestisci attivazione utenti.'|i18n( 'design/admin/parts/user/menu' )}">{'Utenti da attivare'|i18n( 'design/admin/parts/user/menu' )}</a></li>
</ul>
</div></div></div></div></div></div>
