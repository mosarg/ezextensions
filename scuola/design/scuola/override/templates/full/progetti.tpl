{* Progetti - Full view *}
{run-once}
 {ezscript_require( array('classes/equal_height.js','classes/navigator.js','init_navigator.js','init_equal_heights.js'))}
{/run-once}
...
<div id="page_elements" style="visibility:hidden">
            <p title="formats">{array(hash('fname','equalHeights','arguments',''))|json_encode}</p>
</div>         
{undef}