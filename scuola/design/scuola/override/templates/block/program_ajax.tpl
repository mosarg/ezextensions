...
{ezscript_require( array( 'classes/block_program.js','init_blockprogram.js'))}
{/run-once}

{def $calendar_list=array()}
<div class="content-view-block">
    <div class="program-ajax-block" id="{$block.name|preg_replace('/\s/','_')}">
        ...
        <div class="program-list">
           <!-- <div class="position"></div>-->
            <div class="commands"><div class="loading"></div>
                <div class="previous-button arrow "><</div><div class="next-button arrow">></div>
        ...
        <div id="config-{$block.name|preg_replace('/\s/','_')}" style="visibility:hidden">
