...
<p>
     ...
     {switch match=$:item_previous|lt(0) }
       {case match=0}
      <span class="previous"><a class="google-navigator" href={concat($page_uri,$:item_previous|gt(0)|choose('',concat($:offset_text,$:item_previous)),$:view_parameter_text,$page_uri_suffix)|ezurl}><span class="text">&laquo;&nbsp;{"Previous"|i18n("design/standard/navigator")}</span></a></span>
       {/case}
       {case match=1}
       {/case}
     {/switch}
    ...
    {switch match=$:item_next|lt($item_count)}
      {case match=1}
        <span class="next"><a class="google-navigator"  href={concat($page_uri,$:offset_text,$:item_next,$:view_parameter_text,$page_uri_suffix)|ezurl}><span class="text">{"Next"|i18n("design/standard/navigator")}&nbsp;&raquo;</span></a></span>
      {/case}
      {case}
      {/case}
    {/switch}
...
<a class="google-navigator" href={concat($page_uri,$:view_parameter_text,$page_uri_suffix)|ezurl}>1</a>
...
{/section}
    ...
    {section loop=$:left_length}
        {let page_offset=sum(sub($ViewParameter:current_page,$ViewParameter:left_length),$:index)}
          <span class="other"><a class="google-navigator" href={concat($page_uri,$:page_offset|gt(0)|choose('',concat($:offset_text,mul($:page_offset,$item_limit))),$ViewParameter:view_parameter_text,$page_uri_suffix)|ezurl}>{$:page_offset|inc}</a></span>
        {/let}
    {/section}
...
{/section}
<span class="other"><a class="google-navigator" href={concat($page_uri,$:page_count|dec|gt(0)|choose('',concat($:offset_text,mul($:page_count|dec,$item_limit))),$:view_parameter_text,$page_uri_suffix)|ezurl}>{$:page_count}</a></span>
{/section}
