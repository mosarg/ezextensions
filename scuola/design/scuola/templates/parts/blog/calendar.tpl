...
{/if}
{if eq($temp_month|int(), $blog.data_map.publication_date.content.month|int())}
{if is_set($blog.data_map.to_time)}
...
<div class="content-view-embed">
    <div class="class-event-calendar">
        <div class="calendar-month-view">
            ...
            <table cellpadding="0" cellspacing="0" border="0" summary="{'Calendar'|i18n('design/ezwebin/blog/calendar')}" class="shadow month-view">
                <tr class="calendar_heading">
                    <th class="calendar_heading_prev first_col"><a href={$url_back|ezurl} title=" Previous month ">&#8249;&#8249;</a></th>
                    <th class="calendar_heading_date" colspan="5"><a href={$blog_node.url_alias|ezurl}>{$temp_ts|datetime( custom, '%F' )|upfirst()}&nbsp;{$temp_year}</a></th>
                    <th class="calendar_heading_prev first_col"><a href={$url_forward|ezurl} title=" Previous month ">&#8250;&#8250;</a></th>
                </tr>
                <tr class="calendar_heading_days">
                    <th class="first_col">{"Mon"|i18n("design/ezwebin/blog/calendar")}</th>
                    ...
                    <th class="last_col">{"Sun"|i18n("design/ezwebin/blog/calendar")}</th>
                </tr>
