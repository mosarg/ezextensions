...
<h1>{"Register user"|i18n("design/standard/user")}::Personale amministrativo</h1>
</div>
<div>
...
<div class="right-column">
    ...
    I dati necessari per la registrazione sono: nome, cognome,informazioni account,istituto di appartenenza.
    ...
    <ul>
        ...
        <li>
            Ricordatevi di selezionare la vostra mansione
        </li>
