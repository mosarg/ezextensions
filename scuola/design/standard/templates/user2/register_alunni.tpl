...
<h1>{"Register user"|i18n("design/standard/user")}::Alunno</h1>
</div>
<div>
...
<div class="right-column">
    ...
    I dati necessari per la registrazione sono: nome, cognome,informazioni account e istituto di appartenenza.
