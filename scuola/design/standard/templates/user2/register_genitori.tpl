...
<h1>{"Register user"|i18n("design/standard/user")}::Genitore</h1>
</div>
    ...
    <div class="block">
       <div class="block">
        ...
        {switch match=$ContentObjectAttribute.contentclass_attribute.identifier}
            ...
            {/case}
            {case match='matricealunni'}
             <div class="ezcca-edit-matricealunni">
             <h4 class="{$mandatory}">Elenco figli frequentanti la scuola</h4>
                {attribute_edit_gui attribute=$ContentObjectAttribute}
            </div>
            {/case}
...
<div class="right-column">
    ...
    I dati necessari per la registrazione sono: nome, cognome,informazioni account,istituto di appartenenza e lista dei figli.
    ...
    <ul>
        ...
        <li>
            Ricordatevi di inserire i nomi dei vostri figli che frequentano la scuola
        </li>
