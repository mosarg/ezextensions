...
if ( $Module->isCurrentAction( "Edit" ) )
{
    ...
    $http->setSessionVariable('LastAccessesURI',$http->sessionVariable('LastAccessedModifyingURI'));
...
if (isset($Params['class']) ) {
    $classT=$Params['class'];
    $Result['content'] = $tpl->fetch( "design:user/edit_$classT.tpl" );
}else {
    $Result['content'] = $tpl->fetch( "design:user/edit.tpl" );
}
$Result['pagelayout'] = "pagelayout_generic.tpl";
