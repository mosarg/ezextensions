{run-once}
{ezcss_require(array('yui/build/calendar/assets/calendar.css'))}
{ezscript_require( array('yui/build/yahoo-dom-event/yahoo-dom-event.js','yui/build/calendar/calendar.js','ezdatepicker.js'))}
{/run-once}
