...
{def $location_data = array()}
{foreach $locations as $index=>$location}
{if is_set($location.name)}
{set $location_data = $location_data|append($location.data_map[$location_attribute].content)}
{else}
{set $location_data = $location_data|append($location)}
{/if}
