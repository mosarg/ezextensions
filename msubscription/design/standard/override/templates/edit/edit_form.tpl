...
{ezscript_require('block_unload.js')}
      ...
      <div class="border-box">
        ...
        <div class="content-edit">
            ...
            <div class="attribute-header">
                <h1 class="long">{'Edit %1 - %2'|i18n( 'design/msubscription/edit', , array( $class.name|wash, $object.name|wash ) )}</h1>
            </div>
            ...
            <div class="attribute-language">
                ...
                {'Content in %language'|i18n( 'design/msubscription/edit',, hash( '%language', $translation_list[$language_index].locale.intl_language_name ))}&nbsp;<img src="{$translation_list[$language_index].language_code|flag_icon}" style="vertical-align: middle;" alt="{$translation_list[$language_index].language_code}" />
            ...
            {include uri='design:content/edit_attribute_form.tpl'}
