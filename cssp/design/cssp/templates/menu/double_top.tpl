...
<div class="menu">
    <ul>
        <li><a href="/">Home</a></li>
        <li><a href={concat("/user/edit/",$current_user.contentobject_id,"/",
...
<div class="menu shadowmore">
    <ul> {def $base=fetch( 'content', 'node', hash( 'node_id', 2 ) )}
        ...
        {if gt($module_result.path|count,1)}
             {if $module_result.path[1].text|downcase|preg_match('/progetti|benessere|bandi|scuole|tecnica|miglioramento|formazione|disagio/')}
