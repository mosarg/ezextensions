...
<div class="buttonblock">
  ...
  <input class="button" type="submit" name="ChangePasswordButton" value="{'Change password'|i18n('m2000/standard/user')}" />
  <input class="button" type="submit" name="ChangeSettingButton" value="{'Change setting'|i18n('m2000/standard/user')}" />
</div>
