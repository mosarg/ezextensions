(function($) {
    $.fn.extend($.ui.dialog.prototype,{
        ...
        save : function(event){
            ...
            var related_events=options.related_events;
            ...
            calevent.title = 'Prenotazione '+options.item_name;
            ...
            switch(options.action){
                ...
                case 'create':
                    ...
                    $.ez(ezaction,{
                        ...
                        new_event.name=data.content.title;
                        new_event.url_alias=data.content.urlAlias;
                        new_event.start=data.content.start;
                        var test_date=new Date(data.content.start);
                     
                        new_event.end=data.content.end;
                        related_events.push(new_event);
                        self._createObjectRelation(data.content.objectId);
                        self.options.inventary._updateRelatedObjects();
                      });
                    break;
                case 'edit':
        ...
        _createObjectRelation:function(children_object_id){
          var options=this.options;
          var parent_object_id=options.object_id;
          var ezaction='cssp::createOORelation::'+parent_object_id+'::'+children_object_id
           $.ez(ezaction,{
                        postdata: 'ready'
                    });
        }
