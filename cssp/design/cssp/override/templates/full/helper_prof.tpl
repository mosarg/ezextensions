...
{/if}
        ...
        <div class="helper_prof_parlor">
            ...
            <h1>{attribute_view_gui attribute=$node.object.data_map.parlorday}</h1>
            {attribute_view_gui attribute=$node.object.data_map.parlorhour}
            <div>
                <h1>{"Note:"|i18n("design/m2000/full/helper_prof")}</h1>
                {attribute_view_gui attribute=$node.object.data_map.parlornote}
            </div>
        </div>
