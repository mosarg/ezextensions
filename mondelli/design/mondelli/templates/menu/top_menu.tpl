...
<div class="menu">
    <ul>
        <li><a class="body_font" href="/">Home</a></li>
        <li><a class="body_font" href={concat("/user2/edit/",$current_user.contentobject_id,"/",
     ...
     {if $current_user.groups|contains(ezini( 'EditGroupSettings', 'EditGroup', 'mondelli.ini' ))}
        <li><a class="body_font" href={"content/draft"|ezurl}>{"Bozze"|i18n("design/ezwebin/user/edit")}</a></li>
        <li><a class="body_font" href={"/content/pendinglist"|ezurl}>{"In attesa"|i18n("design/ezwebin/user/edit")}</a></li>
        <li><a class="body_font" href={"notification/settings"|ezurl}>{"Imposta Notifiche"|i18n("design/ezwebin/user/edit")}</a></li>
        <li><a class="body_font" href={"collaboration/view/summary"|ezurl}>{"Collaborazione"|i18n("design/scuola/profilo")}</a></li>
     {/if}
    </ul>
</div>
{else}
