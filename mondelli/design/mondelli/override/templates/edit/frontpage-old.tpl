{ezscript_require( array('classes/editactions.js','init_editactions.js'))}

{def $action_url=concat("/content/edit/",$object.id,"/",$edit_version,"/",$edit_language|not|choose(concat($edit_language,"/"),''))}


<form enctype="multipart/form-data" id="editform" name="editform" method="post" action={$action_url|ezurl}>

{include uri='design:parts/website_toolbar_edit.tpl'}

<!-- ZONE CONTENT: START -->

<div class="content-edit-frontpage rounded-more">
